...
const PRICE_SPECS = {
  ...
  realtor_monthly: {
    envKey: "STRIPE_PRICE_REALTOR_MONTHLY",
    fallbackPriceId: "price_realtor_monthly",
    mode: "subscription",
    plan: "realtor",
    priceMonthly: 99,
  },
